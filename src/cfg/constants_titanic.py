# THIS IS SYMLINKED TO CONSTANTS_TITANIC!!!! Even though we are running for AlphaEvolve.
import os
import sys
import numpy as np
import torch
...
# ROOT_DIR = "/storage/ice1/6/9/nlin47/AlphaEvolve/llm-guided-evolution-fork"

ROOT_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
DATA_PATH = os.path.join(ROOT_DIR, "sota/AEvolve/data")
SOTA_ROOT = os.path.join(ROOT_DIR, 'sota/AEvolve')
SEED_NETWORK = os.path.join(SOTA_ROOT, 'seedModel1.py')
MODEL = "model"
